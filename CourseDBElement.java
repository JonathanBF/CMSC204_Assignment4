public class CourseDBElement implements Comparable {
	...
	/**
	 * compares crn of 2 different objects(courses) returns -1 if crn of element is
	 * smaller, 1 if it is greater and 0 if they are equal
	 * 
	...
	public String toString() {
		String course = "Course:" + ID + " CRN:" + crn + " Credits:" + credits + " Instructor:" + instructorName
				+ " Room:" + room;
		return course;
	}
